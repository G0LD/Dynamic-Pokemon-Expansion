...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
	...
	[SPECIES_RATTATA] =          {{EVO_LEVEL, 18, SPECIES_RATICATE, 0}},
	[SPECIES_SPEAROW] =          {{EVO_LEVEL, 18, SPECIES_FEAROW, 0}},
	[SPECIES_EKANS] =            {{EVO_LEVEL, 20, SPECIES_ARBOK, 0}},
	...
	[SPECIES_NIDORINA] =         {{EVO_LEVEL_HOLD_ITEM, 35, SPECIES_NIDOQUEEN, ITEM_MOON_STONE}},
	[SPECIES_NIDORAN_M] =        {{EVO_LEVEL, 16, SPECIES_NIDORINO, 0}},
	[SPECIES_NIDORINO] =         {{EVO_LEVEL_HOLD_ITEM, 35, SPECIES_NIDOKING, ITEM_MOON_STONE}},
	...
	[SPECIES_PARAS] =            {{EVO_LEVEL, 22, SPECIES_PARASECT, 0}},
	...
	[SPECIES_POLIWHIRL] =        {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_POLIWRATH, 0},
								  ...
								  {EVO_LEVEL_HOLD_ITEM, 35, SPECIES_POLITOED, ITEM_KINGS_ROCK}},
	[SPECIES_ABRA] =             {{EVO_LEVEL, 16, SPECIES_KADABRA, 0}},
	[SPECIES_KADABRA] =          {{EVO_TRADE, 0, SPECIES_ALAKAZAM, 0},
								  {EVO_LEVEL_HOLD_ITEM, 35, SPECIES_ALAKAZAM, ITEM_TWISTED_SPOON}},
	...
	[SPECIES_GRAVELER] =         {{EVO_LEVEL_HOLD_ITEM, 35, SPECIES_GOLEM, ITEM_HARD_STONE},
	...
	[SPECIES_SLOWPOKE] =         {{EVO_LEVEL, 32, SPECIES_SLOWBRO, 0},
								  ...
								  {EVO_LEVEL_HOLD_ITEM, 32, SPECIES_SLOWKING, ITEM_KINGS_ROCK}},
	...
	[SPECIES_DODUO] =            {{EVO_LEVEL, 28, SPECIES_DODRIO, 0}},
	[SPECIES_SEEL] =             {{EVO_LEVEL, 32, SPECIES_DEWGONG, 0}},
	[SPECIES_GRIMER] =           {{EVO_LEVEL, 30, SPECIES_MUK, 0}},
	...
	[SPECIES_HAUNTER] =          {{EVO_TRADE, 0, SPECIES_GENGAR, 0},
								  {EVO_LEVEL_HOLD_ITEM, 35, SPECIES_GENGAR, ITEM_SPELL_TAG}},
	...
	[SPECIES_ONIX] =             {{EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_STEELIX, 0},
								  {EVO_LEVEL_HOLD_ITEM, 30, SPECIES_STEELIX, ITEM_METAL_COAT}},
	...
	[SPECIES_EXEGGCUTE] =        {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR, 0},
							  {EVO_ITEM, ITEM_SHINY_STONE, SPECIES_EXEGGUTOR_A, 0}},
	[SPECIES_CUBONE] =           {{EVO_LEVEL_DAY, 28, SPECIES_MAROWAK, 0},
							  {EVO_LEVEL_NIGHT, 28, SPECIES_MAROWAK_A, 0}},
	[SPECIES_LICKITUNG] =        {{EVO_MOVE, MOVE_BELCH, SPECIES_LICKILICKY, 0}},
	[SPECIES_KOFFING] =          {{EVO_LEVEL, 30, SPECIES_WEEZING, 0},
								  {EVO_ITEM, ITEM_SHINY_STONE, SPECIES_WEEZING_G, 0}},
	[SPECIES_RHYHORN] =          {{EVO_LEVEL, 28, SPECIES_RHYDON, 0}},
	[SPECIES_RHYDON] =           {{EVO_LEVEL_HOLD_ITEM, 40, SPECIES_RHYPERIOR, ITEM_PROTECTOR},
	...
	[SPECIES_SEADRA] =           {{EVO_TRADE_ITEM, ITEM_DRAGON_SCALE, SPECIES_KINGDRA, 0},
								  {EVO_LEVEL_HOLD_ITEM, 45, SPECIES_KINGDRA, ITEM_DRAGON_SCALE}},
	...
	[SPECIES_SCYTHER] =          {{EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_SCIZOR, 0},
								  {EVO_LEVEL_HOLD_ITEM, 30, SPECIES_SCIZOR, ITEM_METAL_COAT},
								  {EVO_LEVEL_HOLD_ITEM, 30, SPECIES_KLEAVOR, ITEM_BLACK_AUGURITE}},
	[SPECIES_ELECTABUZZ] =       {{EVO_LEVEL_HOLD_ITEM, 35, SPECIES_ELECTIVIRE, ITEM_ELECTIRIZER},
								  {EVO_TRADE_ITEM, ITEM_ELECTIRIZER, SPECIES_ELECTIVIRE, 0}},
	[SPECIES_MAGMAR] =           {{EVO_TRADE_ITEM, ITEM_MAGMARIZER, SPECIES_MAGMORTAR, 0},
								  {EVO_LEVEL_HOLD_ITEM, 35, SPECIES_MAGMORTAR, ITEM_MAGMARIZER}},
	...
	[SPECIES_PORYGON] =          {{EVO_LEVEL_HOLD_ITEM, 0, SPECIES_PORYGON2, ITEM_UP_GRADE},
	...
	[SPECIES_FERALIGATR] =       {{EVO_MEGA, ITEM_FERALIGATITE, SPECIES_FERALIGATR_MEGA, MEGA_VARIANT_STANDARD}},
	...
	[SPECIES_PORYGON2] =         {{EVO_TRADE_ITEM, ITEM_DUBIOUS_DISC, SPECIES_PORYGON_Z, 0},
								  {EVO_LEVEL_HOLD_ITEM, 0, SPECIES_PORYGON_Z, ITEM_DUBIOUS_DISC}},
	...
	[SPECIES_SMOOCHUM] =         {{EVO_LEVEL, 28, SPECIES_JYNX, 0}},
	[SPECIES_ELEKID] =           {{EVO_LEVEL, 28, SPECIES_ELECTABUZZ, 0}},
	[SPECIES_MAGBY] =            {{EVO_LEVEL, 28, SPECIES_MAGMAR, 0}},
	...
	[SPECIES_FEEBAS] =           {/*{EVO_BEAUTY, 0, SPECIES_MILOTIC, 0},*/
								  {EVO_LEVEL_HOLD_ITEM, 0, SPECIES_MILOTIC, ITEM_PRISM_SCALE},
	...
	[SPECIES_TRAPINCH] =         {{EVO_LEVEL, 25, SPECIES_VIBRAVA, 0}},
	...
	[SPECIES_DUSCLOPS] =         {{EVO_LEVEL_HOLD_ITEM, 40, SPECIES_DUSKNOIR, ITEM_REAPER_CLOTH},
	...
	[SPECIES_CLAMPERL] =         {{EVO_LEVEL_HOLD_ITEM, 0, SPECIES_HUNTAIL, ITEM_DEEP_SEA_TOOTH},
								  {EVO_LEVEL_HOLD_ITEM, 0, SPECIES_GOREBYSS, ITEM_DEEP_SEA_SCALE},
	...
	[SPECIES_ARON] =             {{EVO_LEVEL, 20, SPECIES_LAIRON, 0}},
	[SPECIES_LAIRON] =           {{EVO_LEVEL, 36, SPECIES_AGGRON, 0}},
	...
	[SPECIES_LUXRAY] =           {{EVO_MEGA, 438, SPECIES_LUXRAY_MEGA, MEGA_VARIANT_STANDARD}},
	...
	[SPECIES_HIPPOPOTAS] =       {{EVO_LEVEL, 30, SPECIES_HIPPOWDON, 0}},
	[SPECIES_SKORUPI] =          {{EVO_LEVEL, 30, SPECIES_DRAPION, 0}},
	...
	[SPECIES_BOLDORE] =          {{EVO_LEVEL_HOLD_ITEM, 35, SPECIES_GOLEM, ITEM_HARD_STONE},
								  {EVO_TRADE, 0, SPECIES_GIGALITH, 0}},
	[SPECIES_WOOBAT] =           {{EVO_FRIENDSHIP, 0, SPECIES_SWOOBAT, 0}},
	[SPECIES_DRILBUR] =          {{EVO_LEVEL, 28, SPECIES_EXCADRILL, 0}},
	...
	[SPECIES_GURDURR] =          {{EVO_TRADE, 0, SPECIES_CONKELDURR, 0},
								  {EVO_LEVEL, 38, SPECIES_CONKELDURR, 0}},
	[SPECIES_TYMPOLE] =          {{EVO_LEVEL, 18, SPECIES_PALPITOAD, 0}},
	[SPECIES_PALPITOAD] =        {{EVO_LEVEL, 36, SPECIES_SEISMITOAD, 0}},
	[SPECIES_SEWADDLE] =         {{EVO_LEVEL, 14, SPECIES_SWADLOON, 0}},
	[SPECIES_SWADLOON] =         {{EVO_FRIENDSHIP, 0, SPECIES_LEAVANNY, 0}},
	[SPECIES_VENIPEDE] =         {{EVO_LEVEL, 15, SPECIES_WHIRLIPEDE, 0}},
	[SPECIES_WHIRLIPEDE] =       {{EVO_LEVEL, 28, SPECIES_SCOLIPEDE, 0}},
	[SPECIES_COTTONEE] =         {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_WHIMSICOTT, 0}},
	[SPECIES_PETILIL] =          {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_LILLIGANT, 0}},
	[SPECIES_SANDILE] =          {{EVO_LEVEL, 22, SPECIES_KROKOROK, 0}},
	[SPECIES_KROKOROK] =         {{EVO_LEVEL, 38, SPECIES_KROOKODILE, 0}},
	[SPECIES_DARUMAKA] =         {{EVO_LEVEL, 30, SPECIES_DARMANITAN, 0}},
	[SPECIES_DWEBBLE] =          {{EVO_LEVEL, 24, SPECIES_CRUSTLE, 0}},
	[SPECIES_SCRAGGY] =          {{EVO_LEVEL, 28, SPECIES_SCRAFTY, 0}},
	[SPECIES_YAMASK] =           {{EVO_LEVEL, 29, SPECIES_COFAGRIGUS, 0}},
	[SPECIES_TIRTOUGA] =         {{EVO_LEVEL, 30, SPECIES_CARRACOSTA, 0}},
	[SPECIES_ARCHEN] =           {{EVO_LEVEL, 30, SPECIES_ARCHEOPS, 0}},
	[SPECIES_TRUBBISH] =         {{EVO_LEVEL, 25, SPECIES_GARBODOR, 0}},
	...
	[SPECIES_GOTHITA] =          {{EVO_LEVEL, 18, SPECIES_GOTHORITA, 0}},
	[SPECIES_GOTHORITA] =        {{EVO_LEVEL, 36, SPECIES_GOTHITELLE, 0}},
	[SPECIES_SOLOSIS] =          {{EVO_LEVEL, 18, SPECIES_DUOSION, 0}},
	[SPECIES_DUOSION] =          {{EVO_LEVEL, 36, SPECIES_REUNICLUS, 0}},
	[SPECIES_DUCKLETT] =         {{EVO_LEVEL, 22, SPECIES_SWANNA, 0}},
	[SPECIES_VANILLITE] =        {{EVO_LEVEL, 19, SPECIES_VANILLISH, 0}},
	[SPECIES_VANILLISH] =        {{EVO_LEVEL, 34, SPECIES_VANILLUXE, 0}},
	[SPECIES_DEERLING] =         {{EVO_LEVEL, 22, SPECIES_SAWSBUCK, 0}},
	[SPECIES_KARRABLAST] =       {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_ESCAVALIER, 0},
								  {EVO_TRADE, 0, SPECIES_ESCAVALIER, 0}},
	[SPECIES_FOONGUS] =          {{EVO_LEVEL, 27, SPECIES_AMOONGUSS, 0}},
	[SPECIES_FRILLISH] =         {{EVO_LEVEL, 26, SPECIES_JELLICENT, 0}},
	[SPECIES_JOLTIK] =           {{EVO_LEVEL, 24, SPECIES_GALVANTULA, 0}},
	[SPECIES_FERROSEED] =        {{EVO_LEVEL, 28, SPECIES_FERROTHORN, 0}},
	[SPECIES_KLINK] =            {{EVO_LEVEL, 16, SPECIES_KLANG, 0}},
	[SPECIES_KLANG] =            {{EVO_LEVEL, 36, SPECIES_KLINKLANG, 0}},
	[SPECIES_TYNAMO] =           {{EVO_LEVEL, 14, SPECIES_EELEKTRIK, 0}},
	[SPECIES_EELEKTRIK] =        {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_EELEKTROSS, 0}},
	[SPECIES_ELGYEM] =           {{EVO_LEVEL, 21, SPECIES_BEHEEYEM, 0}},
	[SPECIES_LITWICK] =          {{EVO_LEVEL, 30, SPECIES_LAMPENT, 0}},
	[SPECIES_LAMPENT] =          {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_CHANDELURE, 0}},
	[SPECIES_AXEW] =             {{EVO_LEVEL, 25, SPECIES_FRAXURE, 0}},
	[SPECIES_FRAXURE] =          {{EVO_LEVEL, 45, SPECIES_HAXORUS, 0}},
	[SPECIES_CUBCHOO] =          {{EVO_LEVEL, 28, SPECIES_BEARTIC, 0}},
	[SPECIES_SHELMET] =          {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_ACCELGOR, 0},
								  {EVO_TRADE, 0, SPECIES_ACCELGOR, 0}},
	[SPECIES_MIENFOO] =          {{EVO_LEVEL, 25, SPECIES_MIENSHAO, 0}},
	[SPECIES_GOLETT] =           {{EVO_LEVEL, 28, SPECIES_GOLURK, 0}},
	[SPECIES_PAWNIARD] =         {{EVO_LEVEL, 22, SPECIES_BISHARP, 0}},
	[SPECIES_BISHARP] =          {{EVO_LEVEL_HOLD_ITEM, 35, SPECIES_KINGAMBIT, ITEM_MOON_STONE}},
	[SPECIES_RUFFLET] =          {{EVO_LEVEL, 27, SPECIES_BRAVIARY, 0}},
	[SPECIES_VULLABY] =          {{EVO_LEVEL, 27, SPECIES_MANDIBUZZ, 0}},
	[SPECIES_DEINO] =            {{EVO_LEVEL, 25, SPECIES_ZWEILOUS, 0}},
	[SPECIES_ZWEILOUS] =         {{EVO_LEVEL, 45, SPECIES_HYDREIGON, 0}},
	[SPECIES_LARVESTA] =         {{EVO_LEVEL, 30, SPECIES_VOLCARONA, 0}},
	[SPECIES_FRILLISH_F] =       {{EVO_LEVEL, 26, SPECIES_JELLICENT_F, 0}}, //Don't use this! It's just meant to be used as a sprite placeholder
	...
	[SPECIES_DEERLING_SUMMER] =  {{EVO_LEVEL, 22, SPECIES_SAWSBUCK_SUMMER, 0}},
	[SPECIES_DEERLING_AUTUMN] =  {{EVO_LEVEL, 22, SPECIES_SAWSBUCK_AUTUMN, 0}},
	[SPECIES_DEERLING_WINTER] =  {{EVO_LEVEL, 22, SPECIES_SAWSBUCK_WINTER, 0}},
	[SPECIES_HIPPOPOTAS_F] =     {{EVO_LEVEL, 30, SPECIES_HIPPOWDON_F, 0}}, //Don't use this! It's just meant to be used as a sprite placeholder
	...
	[SPECIES_HONEDGE] =          {{EVO_LEVEL, 25, SPECIES_DOUBLADE, 0}},
	...
	[SPECIES_BINACLE] =          {{EVO_LEVEL, 31, SPECIES_BARBARACLE, 0}},
	[SPECIES_SKRELP] =           {{EVO_LEVEL, 35, SPECIES_DRAGALGE, 0}},
	[SPECIES_CLAUNCHER] =        {{EVO_LEVEL, 30, SPECIES_CLAWITZER, 0}},
	...
	[SPECIES_GOOMY] =            {{EVO_LEVEL, 25, SPECIES_SLIGGOO, 0},
	                              {EVO_LEVEL_HOLD_ITEM, 25, SPECIES_SLIGGOO_H, ITEM_HISUI_ROCK}},
	[SPECIES_SLIGGOO] =          {{EVO_RAINY_FOGGY_OW, 45, SPECIES_GOODRA, 0},
	                              {EVO_LEVEL_HOLD_ITEM, 45, SPECIES_GOODRA, ITEM_WATER_STONE}},
	[SPECIES_PHANTUMP] =         {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_TREVENANT, 0},
								  {EVO_ITEM, ITEM_LINK_STONE, SPECIES_TREVENANT, 0}},
	[SPECIES_PUMPKABOO] =        {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_GOURGEIST, 0},
								  {EVO_ITEM, ITEM_LINK_STONE, SPECIES_GOURGEIST, 0}},
	[SPECIES_BERGMITE] =         {{EVO_LEVEL, 27, SPECIES_AVALUGG, 0},
	                              {EVO_LEVEL_HOLD_ITEM, 27, SPECIES_AVALUGG_H, ITEM_HISUI_ROCK}},
	[SPECIES_NOIBAT] =           {{EVO_LEVEL, 35, SPECIES_NOIVERN, 0}},
	...
	[SPECIES_PUMPKABOO_XL] =     {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_GOURGEIST_XL, 0},
								  {EVO_ITEM, ITEM_LINK_STONE, SPECIES_GOURGEIST_XL, 0}},
	[SPECIES_PUMPKABOO_L] =      {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_GOURGEIST_L, 0},
								  {EVO_ITEM, ITEM_LINK_STONE, SPECIES_GOURGEIST_L, 0}},
	[SPECIES_PUMPKABOO_M] =      {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_GOURGEIST_M, 0},
	...
	[SPECIES_CUTIEFLY] =         {{EVO_LEVEL, 22, SPECIES_RIBOMBEE, 0}},
	[SPECIES_ROCKRUFF] =         {{EVO_LEVEL_DAY, 22, SPECIES_LYCANROC, 0},
								  {EVO_LEVEL_NIGHT, 22, SPECIES_LYCANROC_N, 0},
								  {EVO_LEVEL_SPECIFIC_TIME_RANGE, 22, SPECIES_LYCANROC_DUSK, TIME_RANGE(17, 20)}}, //5 PM - 7:59 PM 
	[SPECIES_MAREANIE] =         {{EVO_LEVEL, 28, SPECIES_TOXAPEX, 0}},
	[SPECIES_MUDBRAY] =          {{EVO_LEVEL, 30, SPECIES_MUDSDALE, 0}},
	[SPECIES_DEWPIDER] =         {{EVO_LEVEL, 22, SPECIES_ARAQUANID, 0}},
	[SPECIES_FOMANTIS] =         {{EVO_LEVEL_DAY, 24, SPECIES_LURANTIS, 0}},
	[SPECIES_MORELULL] =         {{EVO_LEVEL, 24, SPECIES_SHIINOTIC, 0}},
	[SPECIES_SALANDIT] =         {{EVO_FEMALE_LEVEL, 23, SPECIES_SALAZZLE, 0}},
	...
	[SPECIES_WIMPOD] =           {{EVO_LEVEL, 25, SPECIES_GOLISOPOD, 0}},
	[SPECIES_SANDYGAST] =        {{EVO_LEVEL, 22, SPECIES_PALOSSAND, 0}},
	[SPECIES_TYPE_NULL] =        {{EVO_FRIENDSHIP, 0, SPECIES_SILVALLY, 0}},
	[SPECIES_JANGMO_O] =         {{EVO_LEVEL, 25, SPECIES_HAKAMO_O, 0}},
	[SPECIES_HAKAMO_O] =         {{EVO_LEVEL, 45, SPECIES_KOMMO_O, 0}},
	[SPECIES_COSMOG] =           {{EVO_LEVEL, 30, SPECIES_COSMOEM, 0}},
	[SPECIES_COSMOEM] =          {{EVO_LEVEL_DAY, 50, SPECIES_SOLGALEO, 0},
								  {EVO_LEVEL_NIGHT, 50, SPECIES_LUNALA, 0}},
	[SPECIES_RATTATA_A] =        {{EVO_LEVEL_NIGHT, 18, SPECIES_RATICATE_A, 0}},
	...
	[SPECIES_GRAVELER_A] =       {{EVO_LEVEL_HOLD_ITEM, 0, SPECIES_GOLEM_A, ITEM_MAGNET},
								  {EVO_TRADE, 0, SPECIES_GOLEM_A, 0}},
	[SPECIES_GRIMER_A] =         {{EVO_LEVEL, 30, SPECIES_MUK_A, 0}},
	...
	[SPECIES_MELTAN] =	         {{EVO_ITEM, ITEM_METAL_COAT, SPECIES_MELMETAL, 0},
								  {EVO_LEVEL_HOLD_ITEM, 0, SPECIES_MELMETAL, ITEM_METAL_POWDER}},
	...
	[SPECIES_SKWOVET] =          {{EVO_LEVEL, 18, SPECIES_GREEDENT, 0}},
	[SPECIES_ROOKIDEE] =         {{EVO_LEVEL, 15, SPECIES_CORVISQUIRE, 0}},
	[SPECIES_CORVISQUIRE] =      {{EVO_LEVEL, 35, SPECIES_CORVIKNIGHT, 0}},
	[SPECIES_CORVIKNIGHT] =      {{EVO_GIGANTAMAX, TRUE, SPECIES_CORVIKNIGHT_GIGA, 0}},
	[SPECIES_BLIPBUG] =          {{EVO_LEVEL, 10, SPECIES_DOTTLER, 0}},
	[SPECIES_DOTTLER] =          {{EVO_LEVEL, 25, SPECIES_ORBEETLE, 0}},
	[SPECIES_ORBEETLE] =         {{EVO_GIGANTAMAX, TRUE, SPECIES_ORBEETLE_GIGA, 0}},
	[SPECIES_NICKIT] =           {{EVO_LEVEL, 18, SPECIES_THIEVUL, 0}},
	[SPECIES_GOSSIFLEUR] =       {{EVO_LEVEL, 19, SPECIES_ELDEGOSS, 0}},
	[SPECIES_WOOLOO] =           {{EVO_LEVEL, 17, SPECIES_DUBWOOL, 0}},
	[SPECIES_CHEWTLE] =          {{EVO_LEVEL, 17, SPECIES_DREDNAW, 0}},
	[SPECIES_DREDNAW] =          {{EVO_GIGANTAMAX, TRUE, SPECIES_DREDNAW_GIGA, 0}},
	[SPECIES_YAMPER] =           {{EVO_LEVEL, 16, SPECIES_BOLTUND, 0}},
	...
	[SPECIES_SILICOBRA] =        {{EVO_LEVEL, 24, SPECIES_SANDACONDA, 0}},
	[SPECIES_SANDACONDA] =       {{EVO_GIGANTAMAX, TRUE, SPECIES_SANDACONDA_GIGA, 0}},
	[SPECIES_ARROKUDA] =         {{EVO_LEVEL, 26, SPECIES_BARRASKEWDA, 0}},
	[SPECIES_TOXEL] =            {{EVO_NATURE_HIGH, 28, SPECIES_TOXTRICITY, 0},
								  {EVO_NATURE_LOW, 28, SPECIES_TOXTRICITY_LOW_KEY, 0}}, 
	[SPECIES_TOXTRICITY] =       {{EVO_GIGANTAMAX, TRUE, SPECIES_TOXTRICITY_GIGA, 0}},
	[SPECIES_SIZZLIPEDE] =       {{EVO_LEVEL, 26, SPECIES_CENTISKORCH, 0}},
	...
	[SPECIES_HATENNA] =          {{EVO_LEVEL, 25, SPECIES_HATTREM, 0}},
	[SPECIES_HATTREM] =          {{EVO_LEVEL, 35, SPECIES_HATTERENE, 0}},
	[SPECIES_HATTERENE] =        {{EVO_GIGANTAMAX, TRUE, SPECIES_HATTERENE_GIGA, 0}},
	[SPECIES_IMPIDIMP] =         {{EVO_LEVEL, 25, SPECIES_MORGREM, 0}},
	[SPECIES_MORGREM] =          {{EVO_LEVEL, 35, SPECIES_GRIMMSNARL, 0}},
	...
	[SPECIES_CUFANT] =           {{EVO_LEVEL, 26, SPECIES_COPPERAJAH, 0}},
	...
	[SPECIES_DREEPY] =           {{EVO_LEVEL, 25, SPECIES_DRAKLOAK, 0}},
	[SPECIES_DRAKLOAK] =         {{EVO_LEVEL, 45, SPECIES_DRAGAPULT, 0}},
	...
	[SPECIES_SLOWPOKE_G] =       {{EVO_LEVEL_HOLD_ITEM, 0, SPECIES_SLOWBRO_G, ITEM_GALARICA_CUFF},
								  {EVO_LEVEL_HOLD_ITEM, 0, SPECIES_SLOWKING_G, ITEM_GALARICA_WREATH}},
	[SPECIES_FARFETCHD_G] =      {{EVO_CRITICAL_HIT, 0, SPECIES_SIRFETCHD, 0},
								  {EVO_ITEM, ITEM_SHINY_STONE, SPECIES_SIRFETCHD, 0}},
	[SPECIES_KOFFING_G] =        {{EVO_LEVEL, 30, SPECIES_WEEZING_G, 0}},
	...
	[SPECIES_YAMASK_G] =         {{EVO_LEVEL, 29, SPECIES_RUNERIGUS, 0}/*,
	...
	[SPECIES_SLIGGOO_H] =        {{EVO_RAINY_FOGGY_OW, 45, SPECIES_GOODRA_H, 0},
	                              {EVO_LEVEL_HOLD_ITEM, 45, SPECIES_GOODRA_H, ITEM_WATER_STONE}},
